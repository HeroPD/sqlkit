    ...
    return ifNotIn(
      ...
      (context: CompletionContext) => {
        ...
        const aliasOptions = (query: ClauseContext): Completion[] => {
          ...
          for (const { alias, table } of visibleBindings(structure, query)) {
        ...
        const boundColumnOptions = (query: ClauseContext): Completion[] => {
          ...
          for (const { seg, qualified, alias, table, outer } of visibleBindings(structure, query)) {
        ...
        const onConditions = (pos: number): string[] => {
          ...
          for (const { alias, table } of tableBindings(structure, queryContextAt(pos))) {
